...
VALUES  ('UNIT_MISSIONARY', 'CAN_MOVE_AFTER_PURCHASE', 1, 'PROPERTYTYPE_IDENTITY'),
        ...
        ('UNIT_CULTIST', 'CAN_MOVE_AFTER_PURCHASE', 1, 'PROPERTYTYPE_IDENTITY'),
        ('UNIT_CULTIST', 'CAN_TELEPORT_TO_CITY', 1, 'PROPERTYTYPE_IDENTITY'),
        ('UNIT_SOOTHSAYER', 'CAN_MOVE_AFTER_PURCHASE', 1, 'PROPERTYTYPE_IDENTITY'),
        ('UNIT_SOOTHSAYER', 'CAN_TELEPORT_TO_CITY', 1, 'PROPERTYTYPE_IDENTITY');